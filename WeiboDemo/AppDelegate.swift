...
//  WeiboDemo
//
//  Created by Jennifer on 16/11/15.
...
//        window?.rootViewController = XLTabBarController()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.gxl.WeiboDemo" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("WeiboDemo", withExtension: "momd")!
